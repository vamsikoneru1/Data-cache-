	...
	<c:choose>
		<c:when test="${mode=='MODE_HOME' }">
			<div class="container" id="homediv">
				<div class="jumbotron text-center">
					<h1>Welcome to UAlbany Demo presentation</h1>
					<h3>Please Register if you want to further proceede</h3>
				</div>
			</div>
		...
		<c:when test="${mode=='MODE_REGISTER' }">
			<div class="container text-center">
				...
				<hr>
				<form class="form-horizontal" method="POST" action="save-user" modelAttribute="reg_form">
